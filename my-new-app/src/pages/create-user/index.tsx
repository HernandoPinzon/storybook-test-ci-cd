...
const CreateUser: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append('name', (document.getElementById('userName') as HTMLInputElement).value);
    formData.append('email', (document.getElementById('userEmail') as HTMLInputElement).value);
